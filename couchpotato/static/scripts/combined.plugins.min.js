...
var QualityBase = new Class({
    ...
    createSizes: function() {
        ...
        new Element("div.item.head.ctrlHolder").adopt(new Element("span.label", {
            ...
            text: "Max"
        }), new Element("span.hd_label", {
            text: "HD"
        }), new Element("span.allow_3d_label", {
            text: "3D"
        }), new Element("span.median_size", {
            text: "Median"
        }), new Element("span.width", {
            text: "Width"
        }), new Element("span.height", {
            text: "Height"
        }), new Element("span.alternative", {
            text: "Alternative"
        }), new Element("span.allow", {
            text: "Allow"
        }), new Element("span.ext", {
            text: "Extensions"
        }), new Element("span.tags", {
            text: "Tags"
        })).inject(group);
        Array.each(self.qualities, function(quality) {
            new Element("div.ctrlHolder.item").adopt(new Element("span.label", {
                ...
                value: quality.alternative instanceof Array ? quality.alternative.map(function(e) {
                    return e instanceof Array ? e.join(" ") : e;
                }).join(", ") : quality.alternative,
                events: {
                    keyup: function(e) {
                ...
                value: quality.allow instanceof Array ? quality.allow.map(function(e) {
                    return e instanceof Array ? e.join(" ") : e;
                }).join(", ") : quality.allow,
                events: {
                    keyup: function(e) {
                ...
                value: quality.ext instanceof Array ? quality.ext.map(function(e) {
                    return e instanceof Array ? e.join(" ") : e;
                }).join(", ") : quality.ext,
                events: {
                    keyup: function(e) {
                ...
                value: quality.tags instanceof Array ? quality.tags.map(function(e) {
                    return e instanceof Array ? e.join(" ") : e;
                }).join(", ") : quality.tags,
                events: {
                    keyup: function(e) {
